...
# at the baseline (2026.06.24), plus what that baseline needs - the same file as duckdb-acl's:
...
#     the flag for MinGW;
#   - a release-only build: the extension links release alone, and the debug variant of grpc and
#     the OpenTelemetry SDK is runner time spent on nothing (the debug build is also where the
#     object overflows first).
